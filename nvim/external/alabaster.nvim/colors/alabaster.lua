...
if vim.o.background == "dark" then
    ...
    local def_fg = ansi.meow
    local const_fg = "#cc8bc9"
    local active = "#cd974b"
    local string_fg = ansi.green
    local darker_fg = "#7d7d7d"
    local diffadd = ansi.green
    local diffdelete = ansi.red
    local diffchange = ansi.yellow
    local statusline = "#162022"
    local comment = ansi.brightyellow
    local dim_comment = "#696969"
    local mistake = {
        fg = ansi.red,
        bg = "#2b1d1e",
    }
    local error = ansi.red
    local warn = ansi.yellow
    local hint = ansi.green
    local info = ansi.green
    ...
    theme = {
        ...
        DiffAdd = { bg = "#244032", fg = diffadd },
        DiffDelete = { bg = "#462c32", fg = diffdelete },
        DiffText = { fg = "#341a00", bg = comment },
        DiffChange = { bg = "#341a00", fg = diffchange },
        ...
        --- NvimTree
        NvimTreeRootFolder = { fg = ansi.magenta, underline = 1, bold = true },
        NvimTreeFolderName = { fg = ansi.brightyellow },
        NvimTreeSpecialFile = { fg = ansi.white }, 
        NvimTreeEmptyFolderName = { fg = ansi.brightyellow },
        NvimTreeOpenedFolderName = { fg = ansi.brightyellow, italic = 1 },
        NvimTreeSymlinkFolderName = { fg = ansi.green },
        ...
        ["@type.builtin"] = { fg = ansi.white, bold = true },
